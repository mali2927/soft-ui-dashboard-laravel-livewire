        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'employee.index' ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        {{ in_array(request()->route()->getName(), ['employee.index']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('shifts.*') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-clock {{ request()->routeIs('shifts.*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('leave-requests') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i
                            class="fas fa-calendar-day {{ request()->routeIs('leave-requests') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('leave-types') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i
                            class="fas fa-tags {{ request()->routeIs('leave-types') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('leave-balances') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i
                            class="fas fa-calculator {{ request()->routeIs('leave-balances') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Leave Balances</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('leave-allocations.*') ? 'active' : '' }}"
                    href="{{ route('leave-allocations.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i
                            class="fas fa-calendar-alt {{ request()->routeIs('leave-allocations.*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Leave Allocations</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->routeIs('authentications.*') ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i
                            class="fas fa-id-card {{ request()->routeIs('authentications.*') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
