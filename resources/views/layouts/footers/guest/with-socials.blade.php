      ...
      <div class="container">
          {{-- <div class="row">
              <div class="col-lg-8 mb-4 mx-auto text-center">
                  <a href="https://www.creative-tim.com" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
                      Company
                  </a>
          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      Copyright © {{ now()->year }} Powered by <a style="color: #252f40;" href="https://novtek.co.uk/"
                          class="font-weight-bold ml-1" target="_blank">Novtek</a>
              </div>
              </p>
          </div>
      </div>
